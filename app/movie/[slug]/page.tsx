  ...
  return (
    <article>
      <section className="relative min-h-[560px] overflow-hidden">
        {movie.thumb || movie.poster ? <img src={proxiedImage(movie.thumb || movie.poster)} alt={movie.name} className="absolute inset-0 h-full w-full object-cover opacity-60" /> : null}
        ...
        <div className="relative z-10 px-4 pb-8 pt-5">
          ...
          <div className="mt-10 flex gap-4">
            <div className="w-36 shrink-0 overflow-hidden rounded-3xl bg-zinc-900 shadow-2xl ring-1 ring-white/10">
              {movie.poster || movie.thumb ? <img src={proxiedImage(movie.poster || movie.thumb)} alt={movie.name} className="aspect-[2/3] h-full w-full object-cover" /> : null}
            </div>
