    ...
    <>
      <header className="sticky top-0 z-40 border-b border-white/5 bg-[#07090f]/90 px-4 py-4 backdrop-blur-xl">
        <form action="/search" className="flex items-center gap-3">
          <label className="flex min-w-0 flex-1 items-center gap-3 rounded-2xl border border-white/10 bg-white/10 px-4 py-3 text-zinc-300">
            <Search className="h-5 w-5 shrink-0" />
            <input name="q" defaultValue={q} placeholder="Tìm kiếm phim, diễn viên..." className="min-w-0 flex-1 bg-transparent text-sm text-white outline-none placeholder:text-zinc-500" autoFocus />
          </label>
